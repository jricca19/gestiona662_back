...
privateRouter.get("/publications/school/:id", roleMiddleware("STAFF"), getPublicationsOfSchoolController);
...
privateRouter.patch("/publications/assignPostulation", roleMiddleware("STAFF"), assignPostulationController);
