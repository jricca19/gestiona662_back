...
const { healthController, getDepartmentsController, getDepartmentController, getSchoolsSelectController, postSchoolController, expirePublicationsController } = require("../controllers/public.controller");
...
publicRouter.get("/internal/cron/expire-publications", expirePublicationsController);
